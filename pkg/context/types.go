...
type WAGFNFInfo struct {
	GlobalWAGFID    GlobalWAGFID      `yaml:"GlobalWAGFID" valid:"required"`
...
type GlobalWAGFID struct {
	...
	WAGFID  uint32 `yaml:"WAGFID" valid:"range(0|65535),required"` // with length 2 bytes
}
